...
BOOST_AUTO_TEST_CASE(moveUpTestBasicTest) {
    ...
    State s1(correctPair1.first, PUZZLE_SIZE);
    BOOST_CHECK(s1.moveUp() == correctPair1.second);
    State s2(correctPair2.first, PUZZLE_SIZE);
    BOOST_CHECK(s2.moveUp() == correctPair2.second);
    State s3(correctPair3.first, PUZZLE_SIZE);
...
BOOST_AUTO_TEST_CASE(moveUpTestNoMoveUpTests) {
    ...
    State s1(mapWithNoMoveUp1, PUZZLE_SIZE);
    State s2(mapWithNoMoveUp2, PUZZLE_SIZE);
    State s3(mapWithNoMoveUp3, PUZZLE_SIZE);
    State sGoodForMove(mapGoodForMoveUp, PUZZLE_SIZE);
...
BOOST_AUTO_TEST_CASE(moveDownTestNoMoveDownTests) {
    ...
    State s1(mapWithNoMoveDown1, PUZZLE_SIZE);
    State s2(mapWithNoMoveDown2, PUZZLE_SIZE);
    State s3(mapWithNoMoveDown3, PUZZLE_SIZE);
    State sGoodForMove(mapGoodForMoveDown, PUZZLE_SIZE);
...
BOOST_AUTO_TEST_CASE(moveLeftTestNoMoveLeftTests) {
    ...
    State s1(mapWithNoMoveLeft1, PUZZLE_SIZE);
    State s2(mapWithNoMoveLeft2, PUZZLE_SIZE);
    State s3(mapWithNoMoveLeft3, PUZZLE_SIZE);
    State sGoodForMove(mapGoodForMoveLeft, PUZZLE_SIZE);
...
BOOST_AUTO_TEST_CASE(moveRightTestNoMoveRightTests) {
    ...
    State s1(mapWithNoMoveRight1, PUZZLE_SIZE);
    State s2(mapWithNoMoveRight2, PUZZLE_SIZE);
    State s3(mapWithNoMoveRight3, PUZZLE_SIZE);
    State sGoodForMove(mapGoodForMoveRight, PUZZLE_SIZE);
